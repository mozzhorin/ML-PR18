...
#model = torch.load('CNN_8_x4_notbalanced.model', map_location='cuda').to(device)
...
writer = SummaryWriter('runs/CNN_8_x4_notbalanced')
...
for epoch in range(total_epochs):
    ...
    torch.save(model, 'CNN_8_x4_notbalanced.model')
writer.close()